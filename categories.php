    ...
    <body>
        ...
        <div class="register_space">
            <div class="content_container">
                <div class="title">Category Addition</div>
                    <form method="post" action="process_categories.php">
                        <div class="user_details">
                            <div class="input_box">
                                <span class="details">Category name</span>
                                <input class="input" type="text" placeholder="Enter the category name" id="category_name" name="categoryName" required>
                            </div>
                            <div class="input_box">
                                <span class="details">Category description</span>
                                <textarea class="input" placeholder="Enter the category description" id="category_description" 
                                name="categoryDescription" rows="5" columns="100" required></textarea>
                            </div>
                            <div class="input_box">
