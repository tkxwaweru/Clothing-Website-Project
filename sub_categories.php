...
<html>
    <head>
        <meta charset="utf-8">
        <title>Sub-category Addition</title>
    ...
    <body>
        ...
        <div class="register_space">
            <div class="content_container">
                <div class="title">Sub-category Addition</div>
                    <form method="post" action="process_sub_categories.php">
                        <div class="user_details">
                            <div class="input_box">
                                <span class="details">Sub-category name</span>
                                <input class="input" type="text" placeholder="Enter the sub-category name" id="sub_category_name" name="subCategoryName" required>
                            </div>
                            <div class="input_box">
                                <span class="details">Sub-category description</span>
                                <textarea class="input" placeholder="Enter the sub-category description" id="sub_category_description" 
                                name="subCategoryDescription" rows="5" columns="100" required></textarea>
                            </div>
                            <div class="input_box">
