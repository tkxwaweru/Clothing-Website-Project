...
<body>
<form method="POST" action="process_mens_cart.php">
<div id="shopping-cart">
<div class="txt-heading">My cart</div>

<a id="btnEmpty" href="order_mens.php?action=empty">Empty Cart</a>
<?php
...
<div id="product-grid">
	...
	<?php
	$product_array = $db_handle->runQuery("SELECT * FROM products WHERE categoryID = 1 ORDER BY productID ASC");
